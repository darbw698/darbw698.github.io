...
var base = new Airtable({apiKey: 'keyQh94iubcuyd4vc'}).base('appQaj27DrUvWOXDI');
...
function showBook(book, div) {
  ...
  bookDetail.getElementsByClassName("book_cover")[0].src =
    book.fields.book_cover[0].url;
